...
def ApplicationFunction(self, client):				
	...
	# Hàm khởi động 1 app
		...
		Start = Button(self.app, text="Start", bg = "#add8e6", activebackground='#7e5a5c', font = "Helvetica 11 bold",padx = 30, pady = 20, command = Start_App, bd = 5).grid(row = 0, column = 0, padx = 8)
		Watch = Button(self.app, text = "Watch",bg = "#add8e6", activebackground='#7e5a5c',font = "Helvetica 11 bold", padx = 30,  pady = 20, command = Watch_App, bd = 5).grid(row = 0, column = 1, padx = 8)
		Kill = Button( self.app, text = "Kill",bg = "#add8e6", activebackground='#7e5a5c',font = "Helvetica 11 bold", padx = 30,  pady = 20, command= Kill_App, bd = 5).grid(row = 0, column = 2, padx = 8)
		Delete = Button(self.app, text =  "Delete",bg = "#add8e6", activebackground='#7e5a5c', font = "Helvetica 11 bold",padx = 30, pady = 20, command = Clear, bd = 5).grid(row = 0, column = 3, padx = 8)
