...
def ProcessFunction(self, client):
    self.process = Tk()
...
# Hàm khởi động 1 process
    ...
    Start = Button(self.process, text="Start", font="Helvetica 10 bold", padx=30, pady=20, command=Start_Process, bd=5, bg = "#add8e6", activebackground='#7e5a5c').grid(row=0, column=0, padx=8)
    Watch = Button(self.process, text="Watch", font="Helvetica 10 bold", padx=30, pady=20, command=Watch_Processes, bd=5, bg = "#add8e6", activebackground='#7e5a5c').grid(row=0, column=1, padx=8)
    Kill = Button(self.process, text="Kill", font="Helvetica 10 bold", padx=30, pady=20, command=Kill_Process, bd=5, bg = "#add8e6", activebackground='#7e5a5c').grid(row=0, column=2, padx=8)
    Delete = Button(self.process, text="Delete", font="Helvetica 10 bold", padx=30, pady=20, command=Clear, bd=5, bg = "#add8e6", activebackground='#7e5a5c').grid(row=0, column=3, padx=8)
